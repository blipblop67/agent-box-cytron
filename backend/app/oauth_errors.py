...
<li>The Client ID / Client Secret on the Settings page are missing, mistyped,
or belong to a different Google Cloud project than the one the redirect URI
was registered on.</li>
<li>The Gmail, Drive, Calendar, or Sheets API hasn't been enabled for this
project (APIs &amp; Services &rarr; Library).</li>
</ul>
"""
