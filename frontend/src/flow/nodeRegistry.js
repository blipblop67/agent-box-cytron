import { LogIn, LogOut, Sparkles, BookOpen, Mail, HardDrive, Calculator, Send } from 'lucide-react'
...
export const PALETTE_ORDER = ['input', 'llm', 'knowledge_base', 'email', 'drive', 'telegram', 'calculator', 'output']
